...
L'OSINT è generalemnte definito come una qualsiasi azione di intelligence eseguita con l'utilizzo di informazioni pubblicamente consultabili (Open Source)\footnote{Giornali, riviste, TV, radio, report commericali, social media, siti e forum}, che sia raccolto, ordinato e diffuso in modo tempestivo allo scopo di rispondere a requisiti specifici.
...
Generalmente il programma preinstallato windows defender può essere sufficente come barriera contro la maggior parte delle minacce conosciute.

\'E consigliabile inoltre che, se il sistema utilizzato sia Windows o Mac, sia predisposto un ulteriore livello di protezione da file dannosi \textbf{Malware}, uno dei software più utilizzati a questo scopop è "Malwarebytes", software che permette la pulizia e la protezione del dispositivo da diversi tipi di minaccia malware.
...
Come definito in precedenza l'Open Source Intelligence si riferisce alla raccolta, all'analisi e all'utilizzo di informazioni provenienti da fonti esclusivamente da fonti di informazione pubblicamente accessibili. 
...
\begin{itemize}
    ...
    \item Protezione della Reputazione
...
\newpage
La Storia dell'OSINT è ricoducibile agli albori della Seconda guerra mondiale, con l'istituzione dell BBC Monitoring Service nel Regno Unito, 1939, e del Foreign Broadcast Monitoring Service (FBMS) negli Stati Uniti, 1941. 
...
\newpage
Sebbene la raccolta e lo sfruttamento di dati da fonti pubblicamente accessibili non aveva guadagnato importantza fino a questo momento, l'importanza dei dati da fonti pubbliche risale a molto tempo prima.
...
L'OSINT passivo compende la raccolta e l'analisi dei dati, senza interagire direttamente con essi o con la loro sorgente. Per esempio un'intelligence di questo tipo può essere la ricerca e la raccolta di dati online da siti, social media e database pubblici, immagini satellitari e mappe.
Rientra in questa tipologia anche la consultazione di documenti pubblici, report e articoli.

L'OSINT attivo riguarda invece tutte quelle tecniche o operazioni che necessitano di un'interazione con la fonte, con gruppi o con utenti finali, i quali andranno a fornire i dati richiesti. Alcuni esempi sono, prendere parte ad un forum online, ad una discussion board o a diverse community presenti sui social riguardo ad uno specifico argomento. 
...
Secondo Neotas\footnote{Azienda specializzata nell'Open Source Intelligence, analisi dati, Intelligenza Artificiale (AI), che mette a disposizione diversi servizi all'avanguardia, background checks e Risk assessment e valutazioni di rischio, allo scopo di aiutare diverse aziende a prendere decisioni informate e a gestire i rischi in modo efficace.} e IBM \footnote{"Big Blue", è un'azienda statunitense del settore informatico, tra le più importanti al mondo. Produce e commercializza hardware, software e servizi informatici, offrendo infrastrutture, servizi di hosting, cloud, intelligenza artificiale, computazione quantistica e consulenza} esistono diverse tecniche e strumenti per condurre attività di intelligence:
    ...
    \item \textbf{Dark Web Monitoring:}
        \begin{enumerate}
            ...
            \item Monitoring di trasazioni di Cryptovalute: I tool per l'analisi del Blockchain come Chainalysis and Elliptic permettono di monitorare e tracciare le transazioni che avvengono con le cryptovalute, potenzialmente scoprire transazioni illecite e attività sul dark web.
        \end{enumerate}
...
\setcounter{enumi}{\value{TMPenumnbr}}
    \item \textbf{Intelligence Geospaziale (GEOINT):}
        \begin{enumerate}
            \item Telerilevamento e Analisi di Immagini Satellitari: Tecniche più avanzate comprendono l'uso di dati di telerilevamento provenienti da fonti quali, Landset, Sentinel e fornitori commericiali uniti ad algoritmi di machine learning e rilevamento di oggetti, cambiamenti e pattern recognition.
            \item Modellazione e visualizzazione 3D: Tools come ArcGIS Pro e ENVI possono essere utilizzati per creare modelli 3D di aree georgrafiche, per l'analisi dei dettagli di un territorio, per le infrastrutture e per divere attività.
    ...
    \item \textbf{Informatica Forense:}
        \begin{enumerate}
            \item Memory Forensics: Strumenti quali Volatility and Rekall possono essere utlizzati per analizzare ed estrarre i dati da system memory dump di sistemi, consentendo il recupero di dati crittografati, file eliminati e numerose risorse forensi.
            \item Disk and File System Forensics: Sono tecniche avanzate, che prevedono l'utlizzo di strumenti come The Sleuth Kit, EnCase, e FTK per eseguire un'analisi approfondita delle immagini del disco e del file system, per recuperare dati cancellati e per l'analisi di metadati e prove digitali.
    ...
    \item \textbf{Machine Learning e Inteligenza Artificiale:}
        \begin{enumerate}
            ...
            \item Computer Vision e Image Recognition: I modelli del Machine learning possono essere allenate per l'analisi e la classificazione di immagini, oggetti, e per l'identificazione di pattern.
            \item Predictive Analytics e Rilevamento anomalie: Tecniche quali il clustering, e il rilevamento delle anomalie possono essere utlizzate per l'identificazione di pattern, prevedere eventi futuri e rilevare minacce all'interno di grandi insiemi di dati.
...
\newpage
    ...
    \item \textbf{Data Visualisation e Link Analysis:}
        \begin{enumerate}
            \item Visualizzazione interrattiva dei Dati: Strumenti quali Tableau, Power BI, e D3.js permettono la creazione di visualizzazioni interattive e dinamiche, consentendo agli analisti di esplorare e presentare i dati in modo intuitivo e leggibile.
            \item Analisi di link e Visualizzazione Grafici: Strumenti come Neo4j, Gephi, e Palantir permettono l'analisi dei collegamenti e la visualizzazione di grafici, aiutando gli analisti ad individuare in modo più rapido e preciso, connesioni nascoste e comprendere relazioni complesse tra i dati.
